...
public final class Constantes {
	...
	public static final String GIRAR_NORTE = "N";

	public static final String GIRAR_SUR = "S";

	public static final String GIRAR_ESTE = "E";

	public static final String GIRAR_OESTE = "W";
